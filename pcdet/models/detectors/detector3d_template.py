...
class Detector3DTemplate(nn.Module):
    ...
    def post_processing(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            if type(batch_dict.get('batch_box_std_preds', False)) is not bool:
                box_std_preds = torch.sqrt(torch.exp(batch_dict['batch_box_std_preds']))
            else:
                box_std_preds = None
            ...
            if post_process_cfg.NMS_CONFIG.MULTI_CLASSES_NMS:
                ...
                if type(batch_dict.get('batch_box_std_preds', False)) is not bool:
                    final_boxes_std = box_std_preds[selected]
                else:
                    final_boxes_std = None
            ...
            if final_boxes_std is not None:
                record_dict['pred_boxes_std'] = final_boxes_std
